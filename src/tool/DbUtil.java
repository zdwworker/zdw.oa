...
public class DbUtil {
    ...
    // 并且是有顺序的。自上而下的顺序。
    // 属性资源文件绑定
    private static ResourceBundle bundle = ResourceBundle.getBundle("resource.oa");
    // 根据属性配置文件key获取value
    ...
    public static Connection getConnection() throws SQLException {
        ...
        Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/zdwsql","root","555");
        return conn;
    }
